      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            Descubre tu{" "}
            <span className="text-blue-600">Orientación Política</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Conoce qué partidos políticos se alinean mejor con tus ideas
            basándose en
            <strong> votaciones reales</strong> del Congreso de los Diputados de
            España.
          </p>
          <button
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Contestas preguntas sobre temas importantes
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-bold text-lg mx-auto mb-4">
              ...
              <p className="text-gray-600 text-sm">
                Analizamos tus respuestas con votos reales
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-bold text-lg mx-auto mb-4">
              ...
              <p className="text-gray-600 text-sm">
                Determinamos tu afinidad con cada partido
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-bold text-lg mx-auto mb-4">
              ...
              <p className="text-gray-600 text-sm">
                Recibes resultados con fuentes oficiales
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Portal oficial de votaciones y decisiones parlamentarias
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Publicaciones oficiales y legislación aprobada
                </p>
              </div>
            </div>
          </div>
